        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" > <i class="fa-solid fa-user"></i> {{ auth()->user()->username }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" >|</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @yield('kasir')" aria-current="page" href="{{ url('kasir') }}"> <i class="fa-solid fa-cash-register"></i> Kasir</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @yield('manajer')" aria-current="page" href="{{ url('manajer') }}"> <i class="fa-solid fa-list-check"></i> Manajer</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" >|</a>
                    </li>
