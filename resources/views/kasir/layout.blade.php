        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" > <i class="fa-solid fa-cash-register"></i> {{ auth()->user()->username }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" >|</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @yield('transaksi')" aria-current="page" href="{{ url('transaksi') }}"><i class="fa-solid fa-cart-shopping"></i> Transaksi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" >|</a>
                    </li>
